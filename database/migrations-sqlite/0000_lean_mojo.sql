...
--> statement-breakpoint
CREATE INDEX `mindmaps_user_id_idx` ON `mindmaps` (`user_id`);--> statement-breakpoint
CREATE INDEX `mindmaps_updated_at_idx` ON `mindmaps` (`updated_at`);--> statement-breakpoint
